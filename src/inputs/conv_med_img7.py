...
loaded_vars: SolverInputsSavedDict = torch.load(get_abs_path("conv_med_img7.pth"))
...
gurobi_results: GurobiResults = torch.load(get_abs_path("conv_med_img7_gurobi_results.pth"))
